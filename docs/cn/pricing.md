...
::: tip
**WIN-TRX 与 WIN-USD 正从 6 位精度迁移至 10 位精度。** 标记为**即将停用**的 6 位精度喂价将于 **2026 年 12 月 15 日**停止更新，请在此之前切换到标记为**新**的 10 位精度喂价。
:::
...
| WIN-TRX <span class="feed-badge" role="note" tabindex="0" aria-label="即将停用，2026-12-15 停止更新" data-tip="2026-12-15 停止更新">即将停用</span>     | 6        | [TQvCG1U2jGTVwXLqvFWR27LDtEJZVgRbEg](https://tronscan.org/#/contract/TQvCG1U2jGTVwXLqvFWR27LDtEJZVgRbEg) |
| WIN-TRX <span class="feed-badge feed-badge--new">新</span>     | 10       | [THrLvtop6pv3dwmcNzxh5ArVjYpe4wUBaX](https://tronscan.org/#/contract/THrLvtop6pv3dwmcNzxh5ArVjYpe4wUBaX) |
| WIN-USD <span class="feed-badge" role="note" tabindex="0" aria-label="即将停用，2026-12-15 停止更新" data-tip="2026-12-15 停止更新">即将停用</span>     | 6        | [TSCef3LT3jpLwwXCWhZe3hZoMsYk1ZLif2](https://tronscan.org/#/contract/TSCef3LT3jpLwwXCWhZe3hZoMsYk1ZLif2) |
| WIN-USD <span class="feed-badge feed-badge--new">新</span>     | 10       | [TC3fqP3wRRorkxvcxpHNNCLD3asyDLZGHC](https://tronscan.org/#/contract/TC3fqP3wRRorkxvcxpHNNCLD3asyDLZGHC) |
...
| WIN-TRX <span class="feed-badge" role="note" tabindex="0" aria-label="即将停用，2026-12-15 停止更新" data-tip="2026-12-15 停止更新">即将停用</span>     | 6        | [TP7aHYuXUkKPKsojs9BNJDVyAJeQ2KtfCj](https://nile.tronscan.org/#/contract/TP7aHYuXUkKPKsojs9BNJDVyAJeQ2KtfCj) |
| WIN-TRX <span class="feed-badge feed-badge--new">新</span>     | 10       | [TV7Y32LHvGE1zMLYLKMZR4kaaD7Zvspm9T](https://nile.tronscan.org/#/contract/TV7Y32LHvGE1zMLYLKMZR4kaaD7Zvspm9T) |
| WIN-USD <span class="feed-badge" role="note" tabindex="0" aria-label="即将停用，2026-12-15 停止更新" data-tip="2026-12-15 停止更新">即将停用</span>     | 6        | [TYYMqsRNZTwsiFkRtn2NewvXT9GnnsPBH9](https://nile.tronscan.org/#/contract/TYYMqsRNZTwsiFkRtn2NewvXT9GnnsPBH9) |
| WIN-USD <span class="feed-badge feed-badge--new">新</span>     | 10       | [TAf7mTYnbG7YZhLCNuefwWKpoLMzrAtRqq](https://nile.tronscan.org/#/contract/TAf7mTYnbG7YZhLCNuefwWKpoLMzrAtRqq) |
...
以下示例演示如何通过 `AggregatorV3Interface` 读取 WINkLink 喂价：使用 `latestRoundData()` 读取最新价、按 heartbeat 校验时效性、调用 `decimals()` 处理精度。
...
- `startedAt`：本轮起始时间戳
- `updatedAt`：本轮完成时间戳；请结合该喂价的 heartbeat 校验时效性
- `answeredInRound`：已弃用 —— 此前用于答案需跨多轮计算的场景；在 WINkLink 喂价上恒等于 `roundId`
...
| latestAnswer | 返回最新价格（无时间戳，无法校验时效性） |
...
返回本喂价的最新价格。**不含时间戳，无法校验时效性**；若尚无写入则返回 `0`。`latestRoundData` 同时返回最新价格与时间戳，可用于校验时效性。
