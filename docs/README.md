...
The aggregated transaction contains a report signed by a quorum of data service nodes and includes their observations. To preserve the trustless properties of the WINkLink data service network, the report and the quorum's signatures are verified on-chain.
