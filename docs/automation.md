...
After deploying the Registry contract, the node address needs to be authorized for `performUpkeep` by adding it to the list using setAuthorizedSender method.
