...
- VRF Coordinator（鏈上合約）：用於與VRF服務進行交互的合約。當發出隨機數請求時，它會觸發一個事件，然後通過VRF服務驗證隨機數以及關於其生成方式的證明。
...
完成節點帳號申請,建議參考[節點帳號準備文檔](https://doc.winklink.org/v1/doc/deploy.html#%E5%87%86%E5%A4%87%E8%8A%82%E7%82%B9%E5%B8%90%E5%8F%B7) 。
